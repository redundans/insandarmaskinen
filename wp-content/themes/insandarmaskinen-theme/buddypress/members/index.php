...
<div id="buddypress">
	...
	<form action="" method="post" id="members-directory-form" class="dir-form">
		...
		<div class="item-list-tabs d-none" aria-label="<?php esc_attr_e( 'Members directory main navigation', 'buddypress' ); ?>" role="navigation">
			<ul>
		...
		<div class="item-list-tabs d-none" id="subnav" aria-label="<?php esc_attr_e( 'Members directory secondary navigation', 'buddypress' ); ?>" role="navigation">
			<ul>
				<?php
