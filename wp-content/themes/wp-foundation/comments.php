...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments"><?php comments_number('<span>Inga</span> kommentarer', '<span>En</span> kommentar', '<span>%</span> kommentarer' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
...
<section id="respond" class="respond-form">
	...
	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
  	<div class="alert-box warning">
  		<p>Du måste vara <a href="<?php echo wp_login_url( get_permalink() ); ?>">inloggad</a> för att kommentera.</p>
  	</div>
	<?php else : ?>
	...
	<p class="comments-logged-in-as">Inloggad som <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Log out &raquo;</a></p>
    ...
    <input class="button medium radius blue nice" name="submit" type="submit" id="submit" tabindex="5" value="<?php echo _('Kommentera'); ?>" />
