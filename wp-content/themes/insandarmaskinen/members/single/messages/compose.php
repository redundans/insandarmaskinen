<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<textarea name="content" id="message_content" rows="6" class="span9"><?php bp_messages_content_value(); ?></textarea>
	...
	<div class="submit">
		<input type="submit" class="btn" value="<?php _e( "Send Message", 'buddypress' ); ?>" name="send" id="send" />
	</div>
