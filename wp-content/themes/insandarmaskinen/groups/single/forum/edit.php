...
<?php if ( bp_has_forum_topic_posts() ) : ?>
	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="page-header">
			 <h1><?php _e( 'Edit:', 'buddypress' ); ?> <?php bp_the_topic_title(); ?> (<?php bp_the_topic_total_post_count(); ?>)/h1>
		</div>
		...
		<?php else : ?>
			...
			<div id="edit-post">
				...
				<textarea name="post_text" id="post_text" class="span9" rows="6"><?php bp_the_topic_post_edit_text(); ?></textarea>

				<?php do_action( 'bp_group_after_edit_forum_post' ); ?>

				<input type="submit" class="btn" name="save_changes" id="save_changes" value="<?php _e( 'Save Changes', 'buddypress' ); ?>" />
				<a href="javascript:history.go(-1)" class="btn btn-inverse">Avbryt</a>
